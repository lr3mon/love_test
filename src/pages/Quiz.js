...
const questionData = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: "💖 설렘! 가슴이 뛰어야 연애지!", types: ["운명적 사랑형", "썸만 많고 연애는 글쎄형"] }
    ]
  },
  {
    question: "애정 표현 스타일은?",
    options: [
      { text: "🥰 문자, 전화, 선물! 표현을 아끼지 않음!", types: ["운명적 사랑형", "타이밍 놓치는 아쉬운형"] },
      { text: "🙃 티 안 나게 은근슬쩍 챙겨줌!", types: ["밀당의 고수형", "연애 고수형"] }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      { text: "😍 “YES! 이 순간을 기다렸어!”", types: ["운명적 사랑형", "밀당의 고수형"] },
      { text: "🫠 “잠깐만… 생각 좀 해볼게…”", types: ["타이밍 놓치는 아쉬운형", "돌고 돌아 결국 연애형"] }
    ]
  },
  {
    question: "연애할 때 가장 두려운 순간은?",
    options: [
      { text: "📵 연락 두절! 갑자기 사라지는 그/그녀…", types: ["운명적 사랑형", "자기관리 최우선형"] },
  ...
  },
  {
    ...
    options: [
      { text: "🔍 탐정 모드 발동! “무슨 일 있어?” 바로 확인!", types: ["운명적 사랑형", "돌고 돌아 결국 연애형"] },
      { text: "🧘‍♀ “나도 내 삶을 즐길래~” 그냥 두고 본다!", types: ["솔로 천국형", "연애 고수형"] }
    ]
  },
  {
    ...
    options: [
      ...
      { text: "🎭 새로운 곳에 가고, 새로운 사람들을 만난다!", types: ["연애 고수형", "밀당의 고수형"] }
    ]
  },
  {
